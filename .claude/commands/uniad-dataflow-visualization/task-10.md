# uniad-dataflow-visualization - Task 10

Execute task 10 for the uniad-dataflow-visualization specification.

## Task Description
Create base HTML template in web/templates/base.html

## Code Reuse
**Leverage existing code**: existing report HTML structures
...
## Usage
```
/Task:10-uniad-dataflow-visualization
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create base HTML template in web/templates/base.html"

```
Use the @spec-task-executor agent to implement task 10: "Create base HTML template in web/templates/base.html" for the uniad-dataflow-visualization specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create base HTML template in web/templates/base.html
- Leverage: existing report HTML structures
- Requirements: 1.1, 5.1

## Instructions
- Implement ONLY task 10: "Create base HTML template in web/templates/base.html"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks uniad-dataflow-visualization 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks uniad-dataflow-visualization 10 --mode complete
```
