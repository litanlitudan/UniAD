# uniad-dataflow-visualization - Task 14

Execute task 14 for the uniad-dataflow-visualization specification.

## Task Description
Create ExportManager class in utils/export_manager.py
...
## Usage
```
/Task:14-uniad-dataflow-visualization
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create ExportManager class in utils/export_manager.py"

```
Use the @spec-task-executor agent to implement task 14: "Create ExportManager class in utils/export_manager.py" for the uniad-dataflow-visualization specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Create ExportManager class in utils/export_manager.py
- Leverage: visualizers/mermaid
- Requirements: 5.1, 5.2, 5.4

## Instructions
- Implement ONLY task 14: "Create ExportManager class in utils/export_manager.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks uniad-dataflow-visualization 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks uniad-dataflow-visualization 14 --mode complete
```
