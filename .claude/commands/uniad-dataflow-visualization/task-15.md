# uniad-dataflow-visualization - Task 15

Execute task 15 for the uniad-dataflow-visualization specification.

## Task Description
Add HTML export method to ExportManager

## Code Reuse
**Leverage existing code**: web/template
...
## Usage
```
/Task:15-uniad-dataflow-visualization
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add HTML export method to ExportManager"

```
Use the @spec-task-executor agent to implement task 15: "Add HTML export method to ExportManager" for the uniad-dataflow-visualization specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Add HTML export method to ExportManager
- Leverage: web/template
- Requirements: 5.1

## Instructions
- Implement ONLY task 15: "Add HTML export method to ExportManager"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks uniad-dataflow-visualization 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks uniad-dataflow-visualization 15 --mode complete
```
