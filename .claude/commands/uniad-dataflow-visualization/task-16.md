# uniad-dataflow-visualization - Task 16

Execute task 16 for the uniad-dataflow-visualization specification.

## Task Description
b. Add model version comparison to ExportManager

## Code Reuse
**Leverage existing code**: TaskHeadComparator.generate

## Requirements Reference
**Requirements**: 5.3 (acceptance criteria 3)

## Usage
```
/Task:16-uniad-dataflow-visualization
```

## Instructions

Execute with @spec-task-executor agent the following task: "b. Add model version comparison to ExportManager"

```
Use the @spec-task-executor agent to implement task 16: "b. Add model version comparison to ExportManager" for the uniad-dataflow-visualization specification and include all the below context.
...
## Task Details
- Task ID: 16
- Description: b. Add model version comparison to ExportManager
- Leverage: TaskHeadComparator.generate
- Requirements: 5.3 (acceptance criteria 3)

## Instructions
- Implement ONLY task 16: "b. Add model version comparison to ExportManager"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks uniad-dataflow-visualization 16 --mode complete
...
```bash
claude-code-spec-workflow get-tasks uniad-dataflow-visualization 16 --mode complete
```
