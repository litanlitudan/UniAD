# uniad-dataflow-visualization - Task 22

Execute task 22 for the uniad-dataflow-visualization specification.

## Task Description
Add configuration loading in utils/config_loader.py

## Code Reuse
**Leverage existing code**: existing configuration patterns
...
## Usage
```
/Task:22-uniad-dataflow-visualization
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add configuration loading in utils/config_loader.py"

```
Use the @spec-task-executor agent to implement task 22: "Add configuration loading in utils/config_loader.py" for the uniad-dataflow-visualization specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Add configuration loading in utils/config_loader.py
- Leverage: existing configuration patterns
- Requirements: 1.3

## Instructions
- Implement ONLY task 22: "Add configuration loading in utils/config_loader.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks uniad-dataflow-visualization 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks uniad-dataflow-visualization 22 --mode complete
```
